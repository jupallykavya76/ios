...
print("Nothing")
    ...
    @IBAction func buttonSignChangePressed(_ sender: UIButton) {
        //Changing the sign of the number
        if currentNumbera.first == "-" {
            currentNumbera.removeFirst()
        }
        else if currentNumbera != "0"{
            currentNumbera = "-" + currentNumbera
        }else{
            currentNumbera = "-"
        }
        displayLabel.text = currentNumbera
    }
...
operandTwo += number
    ...
    @IBAction func zeeroButton(_ sender: Any) {
    let number = "0"
    if displayLabel.text == "0"{
    displayLabel.text = ""
    displayLabel.textColor = .white
